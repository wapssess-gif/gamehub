      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={isPending || isDeleting}
            className="rounded-md border border-red-500/50 px-4 py-2 font-medium text-red-400 transition-all hover:bg-red-500/10 active:bg-red-500/20 disabled:opacity-60"
          >
