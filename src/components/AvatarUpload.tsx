            ...
            <>
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  disabled={isPending}
                  className="rounded-md border border-white/30 px-3 py-1.5 text-sm text-white font-medium transition-all duration-200 hover:bg-red-900 hover:border-red-900 disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:border-white/30"
                >
                  {isPending
                    ? t.avatarProcessing
                    : hasAvatar
